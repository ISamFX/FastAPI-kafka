...
from Producer_api.app.schemas import MessageV1
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('test_v1_results.log', mode='w'),
...
class TestMessageV1(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.consumer.subscribe(['new_topic_v1'])

    def test_send_and_consume_message_v1(self):
        """Тестирование отправки и получения сообщения через API v1"""
        logger.info("\n=== Начало теста test_send_and_consume_message_v1 ===")
        
        # Тестовое сообщение для v1
        test_message = {
            "id": 12345,
            "iot_id": "iot-123",
        ...
        try:
            message = MessageV1(**test_message)
            logger.info("Тестовое сообщение соответствует схеме MessageV1")
        ...
        response = client.post("/api/v1/messages", json=test_message)
        ...
        logger.warning(
            "=== Тест test_send_and_consume_message_v1 УСПЕШНО завершен ===\n"
